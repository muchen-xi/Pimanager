...
def _try_restore_backup():  # type: (...) -> dict|None
    # (Python 3.9 compatible — Optional[dict] in comment)
    """尝试从最近的备份恢复配置。"""
    try:
